...
public class WhiteCheckChecker {
	public static boolean whiteInCheck(int[][] board) {
		...
		ArrayList<String> legalMoves = GenerateLegalMoveBlack.legalMoves(board, false);
